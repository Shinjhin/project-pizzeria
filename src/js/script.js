/* global Handlebars, utils, dataSource */ // eslint-disable-line no-unused-vars
{
  ...
  class Product{
    ...
    getElements(){
      ...
      thisProduct.form = thisProduct.element.querySelector(select.menuProduct.form);         //referencja do formularzy w celu
      //console.log('form will find: ', thisProduct.form);  //
      thisProduct.formInputs = thisProduct.form.querySelectorAll(select.all.formInputs);     //uzyskania danych typu: checkboxy itp
      //console.log('formInputs will find: ', thisProduct.formInputs);    
    ...
    initAccordion(){
      ...
      */
      ...
      // zamiana z clickableTrigger.addEventListener('click', function(event) { ponieważ mamy referencje do tego samego miejsca
  ...
  class Cart {
    ...
    add(menuProduct) {
      const thisCart = this;
      console.log('add to cart: ', menuProduct);
